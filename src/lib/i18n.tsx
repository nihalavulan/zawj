...
const ml: Dict = {
  ...
  hero: {
    ...
    sub: (
      <>
        ...
        <span className="font-semibold text-ink">
          Zawj couples-നെ ഒരുമിപ്പിക്കുന്നു.
        </span>
      </>
    ),
    ctaPrimary: "വാട്‌സാപ്പിൽ സംസാരിക്കൂ",
    ctaSecondary: "വിശദമായി അറിയൂ",
    reassurance: ["couples-ന് മാത്രം", "പരിമിതമായ സീറ്റുകൾ", "സമർപ്പിത പിന്തുണ"],
  },
  problem: {
    eyebrow: "പ്രശ്നം",
    title: (
      <>
        ഉംറ വിപണി couples-ന് രണ്ട് വഴികളേ നൽകുന്നുള്ളൂ: {emMl("തിരക്കിൽ")} ചേരുക,
  ...
  value: [
    {
      ...
      points: [
        "ഓരോ couples-നും സ്വകാര്യ മുറികൾ",
        "12 couples-ന് മാത്രമായി 40 സീറ്റ് ബസ്",
        "couples മാത്രമുള്ള ഗ്രൂപ്പ്",
        "couples-നായി പ്രത്യേകം ഒരുക്കിയ സെഷനുകളും അനുഭവങ്ങളും",
      ],
      cta: "Zawj അനുഭവം കാണൂ",
    },
    {
      ...
      points: [
        "ഗ്രൂപ്പിന്റെ സൗകര്യങ്ങളോടെ couples-ന് മുൻഗണന നൽകുന്ന അനുഭവം",
    ...
    },
    {
      ...
      points: [
        ...
        {
          title: "couples-ന്റെ വർക്ക്‌ഷോപ്പ്",
  ...
  comparison: {
    ...
    title: (
      <>
        സാധാരണ പാക്കേജ് vs. {emMl("Zawj")}
      </>
    ),
    colNormal: "സാധാരണ പാക്കേജ്",
    colZawj: "Zawj",
    rows: [
      { label: "ഗ്രൂപ്പ് വലുപ്പം", normal: "40+ തീർത്ഥാടകർ", zawj: "12 couples" },
      { label: "നിങ്ങളുടെ മുറി", normal: "പങ്കിടുന്ന ഇടങ്ങൾ", zawj: "സ്വകാര്യ മുറി" },
      { label: "നിങ്ങളുടെ ഗ്രൂപ്പ്", normal: "സമ്മിശ്ര ജനക്കൂട്ടം", zawj: "couples മാത്രം" },
      { label: "അനുഭവം", normal: "സാധാരണം", zawj: "couples-നായി" },
      { label: "യാത്രാ പദ്ധതി", normal: "നിശ്ചിത ഷെഡ്യൂൾ", zawj: "ശ്രദ്ധയോടെ ഒരുക്കിയത്" },
      { label: "വില", normal: "$", zawj: "$$" },
    ],
    caption: "തിരക്കില്ലാതെ, ഒരു couples ഉംറയിൽ നിന്ന് യഥാർത്ഥത്തിൽ ആഗ്രഹിക്കുന്നതെല്ലാം.",
  },
  steps: {
  ...
  share: {
    ...
    shareTitle: "Zawj — couples-ന്റെ ഉംറ",
    shareText:
      "നമുക്കായി ഞാൻ ഒന്ന് കണ്ടെത്തി 🕋❤️ — couples-നായി മാത്രം ഒരുക്കിയ, ഒരുമിച്ച് അനുഭവിക്കാനുള്ള ഒരു ഉംറ. നമുക്ക് പോയാലോ? ഒന്ന് നോക്കൂ:",
  },
  faq: {
    eyebrow: "പതിവ് ചോദ്യങ്ങൾ",
    title: "couples ഞങ്ങളോട് ചോദിക്കുന്ന ചോദ്യങ്ങൾ",
    items: [
      {
        q: "Zawj ഉംറ ആർക്കുവേണ്ടിയാണ്?",
        a: "വലിയൊരു സമ്മിശ്ര ഗ്രൂപ്പിനുപകരം, കൂടുതൽ സ്വകാര്യതയോടെയും വ്യക്തിഗത ഇടത്തോടെയും couples എന്ന നിലയിൽ അർത്ഥവത്തായ സമയത്തോടെയും ഉംറ ഒരുമിച്ച് അനുഭവിക്കാൻ ആഗ്രഹിക്കുന്ന വിവാഹിത couples-നായി മാത്രമാണ് Zawj രൂപകൽപന ചെയ്തിരിക്കുന്നത്.",
      },
      {
        q: "യാത്ര എപ്പോഴാണ്?",
        a: "ഞങ്ങളുടെ അടുത്ത couples-ന്റെ ഉംറ ഒക്ടോബറിൽ പുറപ്പെടും. ഞങ്ങളുടെ ടീമുമായി സംസാരിക്കൂ, കൃത്യമായ തീയതികൾ, പൂർണ്ണ യാത്രാ പദ്ധതി, ഉൾപ്പെടുന്നതെല്ലാം തീരുമാനിക്കുന്നതിന് മുമ്പ് ഞങ്ങൾ പങ്കിടും.",
      },
      {
        q: "പാക്കേജിൽ എന്തൊക്കെ ഉൾപ്പെടുന്നു?",
        a: "എല്ലാം നിങ്ങൾക്കായി ഒരുക്കിയിരിക്കുന്നു — താമസം, യാത്രാ സൗകര്യം, ശ്രദ്ധയോടെ ഒരുക്കിയ യാത്രാ പദ്ധതി, couples-നെ കേന്ദ്രീകരിച്ചുള്ള സെഷനുകളും അനുഭവങ്ങളും. നിങ്ങൾ ഇബാദത്തിലും ഒരുമിച്ചുള്ള സമയത്തിലും മാത്രം ശ്രദ്ധിച്ചാൽ മതി.",
      },
      {
        q: "ഇത് യഥാർത്ഥത്തിൽ എത്ര സ്വകാര്യമാണ്?",
        a: "ഓരോ couples-നും സ്വന്തം സ്വകാര്യ മുറി ലഭിക്കും, 40 സീറ്റ് ബസിൽ ഗ്രൂപ്പ് 12 couples ആയി പരിമിതപ്പെടുത്തിയിരിക്കുന്നു, തുടക്കം മുതൽ ഒടുക്കം വരെ couples മാത്രം — അതിനാൽ ഒരു ഗ്രൂപ്പിന്റെ സൗകര്യത്തോടും മൂല്യത്തോടും കൂടി ഒരു സ്വകാര്യ യാത്രയുടെ അടുപ്പം നിങ്ങൾക്ക് ലഭിക്കും.",
      },
      {
        q: "ഞാൻ എങ്ങനെ സീറ്റ് റിസർവ് ചെയ്യും?",
        a: "നിങ്ങൾക്ക് താൽപ്പര്യമുണ്ടെന്ന് ഞങ്ങളോട് പറഞ്ഞാൽ മതി. ഞങ്ങളുടെ ടീം ബന്ധപ്പെടും, എല്ലാ വിവരങ്ങളും വിശദീകരിക്കും, തുടക്കം മുതൽ ഒടുക്കം വരെ നിങ്ങളുടെ couples-ന്റെ സീറ്റ് ഉറപ്പിക്കാൻ മാർഗനിർദേശം നൽകും.",
      },
    ],
  },
  finalCta: {
    eyebrow: "12 couples മാത്രം · ഈ ഒക്ടോബർ",
    title: (
      <>
        ഈ ഒക്ടോബറിൽ, {emMl("12 couples")} മാത്രം ഈ യാത്ര ഒരുമിച്ച് നടത്തും.
      </>
    ),
    body: (
      <>
    ...
    recap: [
      "സ്വകാര്യ മുറികളും 12 പേർ മാത്രമുള്ള couples-ന്റെ ഗ്രൂപ്പും",
    ...
    panelTitle: "നിങ്ങളുടെ couples-ന്റെ സീറ്റ് റിസർവ് ചെയ്യൂ",
    panelBody:
    ...
    reassurance: [
      ...
      "സമർപ്പിത couples പിന്തുണ",
      "ഒരു സംഭാഷണം മാത്രം, ബാധ്യതയില്ല",
    ],
  },
  footer: {
    tagline:
      "couples-നായി ശ്രദ്ധയോടെ ഒരുക്കിയ ഒരു ഉംറ — 15+ വർഷത്തെ വിശ്വസ്ത അനുഭവത്തിന്റെ പിന്തുണയോടെ, കൂടുതൽ സ്വകാര്യതയും വ്യക്തിഗത ഇടവും ഒരുമിച്ചുള്ള അർത്ഥവത്തായ സമയവും.",
    getInTouch: "ബന്ധപ്പെടൂ",
    chat: "വാട്‌സാപ്പിൽ ചാറ്റ് ചെയ്യൂ",
    rights: "എല്ലാ അവകാശങ്ങളും നിക്ഷിപ്തം.",
    note: "couples-ന് മാത്രമുള്ള ഒരു ഉംറ അനുഭവം.",
  },
